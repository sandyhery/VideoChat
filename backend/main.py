    ...
    try:
        ...
        with tempfile.NamedTemporaryFile(delete=False, suffix=".xmind") as temp_file:
            with zipfile.ZipFile(temp_file.name, 'w', zipfile.ZIP_DEFLATED) as zip_file:
                ...
                # styles.xml（包含完整主题样式）
                styles_xml = '''<?xml version="1.0" encoding="UTF-8" standalone="no"?><xmap-styles xmlns="urn:xmind:xmap:xmlns:style:2.0" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" version="2.0"><automatic-styles><style id="central" name="" type="topic"><topic-properties border-line-color="#558ED5" border-line-width="3pt" fo:font-family="Open Sans" line-class="org.xmind.branchConnection.curve" line-color="#558ED5" line-width="1pt" shape-class="org.xmind.topicShape.roundedRect" svg:fill="#DCE6F2"/></style><style id="main1" name="" type="topic"><topic-properties border-line-color="#558ED5" border-line-width="2pt" fo:font-family="Open Sans" line-class="org.xmind.branchConnection.curve" line-color="#558ED5" line-width="1pt" shape-class="org.xmind.topicShape.roundedRect" svg:fill="#FFFFFF"/></style><style id="main2" name="" type="topic"><topic-properties border-line-color="#558ED5" border-line-width="2pt" fo:font-family="Open Sans" line-class="org.xmind.branchConnection.curve" line-color="#558ED5" line-width="1pt" shape-class="org.xmind.topicShape.roundedRect" svg:fill="#FFFFFF"/></style><style id="sub" name="" type="topic"><topic-properties border-line-width="0pt" fo:font-family="Open Sans" line-class="org.xmind.branchConnection.curve" shape-class="org.xmind.topicShape.roundedRect" svg:fill="#FFFFFF"/></style><style id="callout" name="" type="topic"><topic-properties border-line-color="#F1BD51" border-line-width="2pt" fo:font-family="Open Sans" shape-class="org.xmind.topicShape.roundedRect" svg:fill="#FBF09C"/></style><style id="summary" name="" type="summary"><summary-properties line-color="#C3D69B" line-width="5pt" shape-class="org.xmind.summaryShape.square"/></style><style id="boundary" name="" type="boundary"><boundary-properties fo:color="#FFFFFF" fo:font-family="Georgia" fo:font-size="10pt" fo:font-style="italic" line-color="#77933C" line-pattern="dot" line-width="3pt" shape-class="org.xmind.boundaryShape.roundedRect" svg:fill="#C3D69B" svg:opacity=".2"/></style><style id="map" name="" type="map"><map-properties color-gradient="none" line-tapered="none" multi-line-colors="none" svg:fill="#FFFFFF"/></style></automatic-styles><master-styles><style id="default" name="Default" type="theme"><theme-properties><default-style style-family="centralTopic" style-id="central"/><default-style style-family="mainTopic" style-id="main1"/><default-style style-family="subTopic" style-id="sub"/><default-style style-family="calloutTopic" style-id="callout"/><default-style style-family="summary" style-id="summary"/><default-style style-family="boundary" style-id="boundary"/><default-style style-family="map" style-id="map"/></theme-properties></style></master-styles><styles/></xmap-styles>'''
